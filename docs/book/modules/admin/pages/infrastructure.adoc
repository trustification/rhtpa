...
----
{
  ...
  "alwaysDisplayInConsole": false,
  "clientAuthenticatorType": "client-secret",
  "secret": "5460cc91-4e20-4edd-881c-b15b169f8a79",
  "redirectUris": [],
  "webOrigins": [],
  "notBefore": 0,
  "bearerOnly": false,
  ...
  "attributes": {
    "realm_client": "false",
    "access.token.lifespan": "300",
    "client.secret.creation.time": "1754035725",
    "post.logout.redirect.uris": "+"
  },
  "authenticationFlowBindingOverrides": {},
  "fullScopeAllowed": true,
...
# Client secrets
CLI_SECRET="5460cc91-4e20-4edd-881c-b15b169f8a79"
...
for client in "${CLIENTS[@]}"; do
	...
	if [ "${client}" == "cli" ]; then
	  ...
	  "$KCADM_PATH" update "clients/${ID}" -r "$REALM" -s "secret=${CLI_SECRET}"
	fi
done
# Create user
...
* **cli**: On the <<_keycloak_clients,clients-cli.json>> file this value is hardcoded to `5460cc91-4e20-4edd-881c-b15b169f8a79`. This value can be Regenerated and retrieved from the **Client Secret** from the Keycloak admin console by navigating to **Clients** -> **cli** -> **Credentials** tab.
