...
pub enum Relation {
    ...
    ProductVersion,
    #[sea_orm(has_many = "super::sbom_ancestor::Entity")]
    Ancestors,
    #[sea_orm(has_many = "super::sbom_describing_cpe::Entity")]
    DescribingCpes,
    #[sea_orm(
...
impl Related<super::sbom_ancestor::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Ancestors.def()
    }
}

impl Related<super::sbom_describing_cpe::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::DescribingCpes.def()
    }
}
